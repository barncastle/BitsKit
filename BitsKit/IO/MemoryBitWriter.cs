...
public ref struct MemoryBitWriter
{
    ...
    /// <summary>Creates a new <see cref="MemoryBitWriter"/> object over a span of bytes</summary>
    public static MemoryBitWriter FromBytes(Span<byte> source)
    {
        return new(source);
    }

    /// <summary>Creates a new <see cref="MemoryBitWriter"/> over a regular managed object</summary>
